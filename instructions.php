...
<div class="all-forms all-forms_warriors-form">
	...
	<div class="instruction">
        ...
        Все бойцы, у которых ЖИЗНЬ больше нуля, автоматически начинают ждать нападения на них и будут защищаться.
        </p>
        <p>
        ...
        <p>
            ...
            Но в защите у сильно преимущество: его штрафы превращаются в бонусы.
        ...
        <p>
            ...
            <ol>
                ...
                <li>Расчитывается сколько ударов необходимо, что бы закончилось здоровье противника.</li>
            </ol>
        ...
        <p>
            ...
            В этой ситуации победа засчитается, только если враг успеет убить за 10 ударов. Иначе будет ничья.
        </p>
        <p>
        ...
        <p>
            <b>Проигравший</b> теряет 30% очков Здоровья, которые равномерно вычитаются со всех характеристик. Т.Е. оппонент становится равномерно слабее.
        </p>
    </div>
    <br><br>
</div>
